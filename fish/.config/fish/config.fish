...
abbr cpiq 'cd ~/bin/ && bash cpinst.sh q && cd ~'
abbr cpil 'cd ~/bin/ && bash cpinst.sh l && cd ~'
abbr cpid 'cd ~/bin/ && bash cpinst.sh d && cd ~'
abbr bbhq 'cd ~/bin/ && bash bh q && cd ~'
abbr bbhl 'cd ~/bin/ && bash bh l && cd ~'
abbr bbhd 'cd ~/bin/ && bash bh d && cd ~'
