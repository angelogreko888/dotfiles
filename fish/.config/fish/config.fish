...
abbr ngr 'sudo nano /etc/default/grub'
abbr ftr 'systemctl daemon-reload'
abbr ft 'sudo nano /etc/fstab'
abbr ba 'sudo nano  /boot/loader/entries/arch.conf'
abbr fh 'nano  .local/share/fish/fish_history'
