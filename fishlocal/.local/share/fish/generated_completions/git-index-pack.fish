...
complete -c git-index-pack -l fsck-objects -d 'Die if the pack contains broken objects, but unlike --strict, don\'t choke on …'
...
complete -c git-index-pack -l thin -d '(see git-pack-objects(1) for details) by adding the excluded objects the delt…'
