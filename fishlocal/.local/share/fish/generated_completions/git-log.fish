...
complete -c git-log -l merge -d 'Show commits touching conflicted paths in the range HEAD'
...
complete -c git-log -l 'no-merges;' -d 'git log'
complete -c git-log -l verify -d 'and show the output'
...
complete -c git-log -l stat-graph-width -d 'or by setting diff. statGraphWidth=<graph-width>.  Using'
...
complete -c git-log -s x -d 'for adding or removing executable bit respectively) in diffstat'
complete -c git-log -s X
complete -c git-log -l '*stat' -d files
...
complete -c git-log -o 'B/70%'
complete -c git-log -s M
complete -c git-log -o 'B20%'
complete -c git-log -l find-renames
complete -c git-log -o 'M90%'
...
complete -c git-log -o 'S<regex>'
complete -c git-log -l pickaxe-regex -d and
complete -c git-log -s G -d 'git log'
...
complete -c git-log -s N -d 'appear as an existing empty file in git diff and a new file in git diff'
complete -c git-log -l cached -d 'git diff and non-existent in git diff'
...
complete -c git-log -o p1 -d 'index header: @@@ <from-file-range> <from-file-range> <to-file-range> @@@ The…'
