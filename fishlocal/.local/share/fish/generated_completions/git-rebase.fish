...
complete -c git-rebase -l autosquash -l no-autosquash -d 'Automatically squash commits with specially formatted messages into previous …'
...
complete -c git-rebase -l empty
complete -c git-rebase -o i/--interactive -d 'is also specified.  stop, ask'
complete -c git-rebase -l cherry-mark -d ') are detected and dropped as a preliminary step (unless'
...
complete -c git-rebase -s C
complete -c git-rebase -l squash
...
complete -c git-rebase -l amend -d 'reset, or a full history rewriting command like m[blue]filter-repom[]\\u[2]\\d'
