...
complete -c git-replay -l merge -d 'Show commits touching conflicted paths in the range HEAD'
...
complete -c git-replay -l update-refs -d 'updates multiple branches in the affected range'
complete -c git-replay -s 1 -d '(negative numbers denote no upper limit)'
complete -c git-replay -l indexed-objects
complete -c git-replay -l 'no-merges;' -d 'git log'
complete -c git-replay -l verify -d 'and show the output'
