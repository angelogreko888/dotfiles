...
complete -c git-status -l cached
complete -c git-status -o uno
complete -c git-status -l untracked-cache -d 'and git update-index'
complete -c git-status -l split-index -d 'no to have git status return more quickly without showing untracked files'
