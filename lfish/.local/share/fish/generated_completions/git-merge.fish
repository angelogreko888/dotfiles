...
complete -c git-merge -l merge -d 'when MERGE_HEAD is present unless MERGE_AUTOSTASH is also present in which ca…'
complete -c git-merge -s u -d '=== >>>.   5. c   5.  4. 2'
complete -c git-merge -s p -d '<path> will show diffs first for the HEAD version and then the MERGE_HEAD ver…'
