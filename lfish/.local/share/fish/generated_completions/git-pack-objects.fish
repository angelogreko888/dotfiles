...
complete -c git-pack-objects -l filter -d 'Omits certain objects (usually blobs) from the resulting packfile'
...
complete -c git-pack-objects -l fix-thin -d '(see git-index-pack(1)) to restore the self-contained property'
