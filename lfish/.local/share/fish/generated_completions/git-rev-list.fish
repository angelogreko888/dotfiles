...
complete -c git-rev-list -l grep -d 'Limit the commits output to ones with a log message that matches the specifie…'
complete -c git-rev-list -l all-match -d 'Limit the commits output to ones that match all given --grep, instead of ones…'
complete -c git-rev-list -l invert-grep -d 'Limit the commits output to ones with a log message that do not match the pat…'
...
complete -c git-rev-list -l cherry-pick -d 'Omit any commit that introduces the same change as another commit on the "oth…'
...
complete -c git-rev-list -l merge -d 'Show commits touching conflicted paths in the range HEAD'
...
complete -c git-rev-list -l batch-check
complete -c git-rev-list -l 'no-merges;' -d 'git log'
complete -c git-rev-list -l 'objects;'
complete -c git-rev-list -l 'objects*;' -d '<filter-spec> may be one of the following:'
complete -c git-rev-list -l verify -d 'and show the output'
...
complete -c git-rev-list -l source -d 'git log %e'
complete -c git-rev-list -l unfold -d 'option was given.  E. g'
complete -c git-rev-list -o ad -d 'might reduce the repository size (by dropping unreachable objects), and wheth…'
