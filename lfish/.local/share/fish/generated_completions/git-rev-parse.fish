...
complete -c git-rev-parse -l output-object-format -d 'Allow oids to be input from any object format that the current repository sup…'
...
complete -c git-rev-parse -l show-ref-format -d 'Show the reference storage format used for the repository'
...
complete -c git-rev-parse -l no-checkout -d AUTO_MERGE
