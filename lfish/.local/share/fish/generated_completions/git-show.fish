...
complete -c git-show -l verify -d 'and show the output'
...
complete -c git-show -l source -d 'git log %e'
...
complete -c git-show -l dd
complete -c git-show -l remerge-diff
complete -c git-show -l no-diff-merges
...
complete -c git-show -l stat-graph-width -d 'or by setting diff. statGraphWidth=<graph-width>.  Using'
...
complete -c git-show -s x -d 'for adding or removing executable bit respectively) in diffstat'
complete -c git-show -l numstat
complete -c git-show -l shortstat
complete -c git-show -s X -l dirstat
complete -c git-show -l '*stat' -d files
...
complete -c git-show -l exit-code
...
complete -c git-show -o 'B/70%'
complete -c git-show -s M
complete -c git-show -o 'B20%'
complete -c git-show -l find-renames
complete -c git-show -l follow -d '<n> is specified, it is a threshold on the similarity index (i. e'
complete -c git-show -o 'M90%'
...
complete -c git-show -o 'S<regex>'
complete -c git-show -l pickaxe-regex -d and
complete -c git-show -s G -d 'git log'
...
complete -c git-show -s N -d 'appear as an existing empty file in git diff and a new file in git diff'
complete -c git-show -l cached -d 'git diff and non-existent in git diff'
...
complete -c git-show -o p1 -d 'index header: @@@ <from-file-range> <from-file-range> <to-file-range> @@@ The…'
